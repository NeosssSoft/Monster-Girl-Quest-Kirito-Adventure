...
init -1 python hide:
    ...
    style.window.background = Frame("ui/frame2.png", 12, 12)
    ...
    style.imagemap.activate_sound = "sfx/click.wav"

    ## Sounds that are used when entering and exiting the game menu.
    ## - Sonidos utilizados cuando se entra o sale del menú del juego.

    config.enter_sound = "sfx/click.wav"
    config.exit_sound = "sfx/click.wav"

    ## A sample sound that can be played to check the sound volume.
    ## - Sonido de ejemplo utilizado para comprobar el volumen.

    config.sample_sound = "sfx/alert.wav"

    ## Music that is played while the user is at the main menu.
    ## - Música del menú principal.

    config.main_menu_music = "sfx/menu.mp3"
    ...
    ##   'init'.)
python early:
    config.save_directory = "Monster Girl Quest Kirito Adventure-1387707875"
...
init python:
    ...
    build.directory_name = "Monster Girl Quest Kirito Adventure-0.5"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Monster Girl Quest Kirito Adventure"
